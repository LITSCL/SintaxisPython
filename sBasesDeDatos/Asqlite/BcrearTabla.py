...
conexion: object = sqlite3.connect(ruta_absoluta + "/db/dbpruebas.db") #Para crear una conexión, se debe entregar la ruta del fichero, en caso de no existir, el fichero se crea automaticamente.
